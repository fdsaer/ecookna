...
export const getStatistics61 = () => {
  const statistics = [
    { id: 1, title: '300 000', text: 'довольных клиентов' },
    { id: 2, title: '2 500 000', text: 'установленных окон' },
    { id: 3, title: '25 лет', text: 'успешной работы' },
  ];
  return statistics;
};
...
export const getAdditions61 = (images) => {
  const additions = [
    { id: 1, image: images?.RollerBlindsImage61, text: 'Рольшторы' },
    {
      id: 2,
      image: images?.HiddenHardwareImage61,
      text: 'Скрытая фурнитура',
    },
    { id: 3, image: images?.DecorImage61, text: 'Декор' },
    { id: 4, image: images?.MosquitoNetsImage61, text: 'Москитные сетки' },
    { id: 5, image: images?.WindowSillsImage61, text: 'Подоконники' },
    { id: 6, image: images?.ChildLockImage61, text: 'Детские замки' },
  ];
  return additions;
};
