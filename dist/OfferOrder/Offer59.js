...
var _ref13 = React.createElement(OCover1, null);
...
var _ref17 = React.createElement("p", {
  class: "o-cover__7"
...
var _ref20 = React.createElement("p", {
  class: "o-cover__14"
}, "Офис продаж:");
...
var _ref24 = React.createElement("div", {
  class: "o-details__11"
}, "Ваш персональный ", React.createElement("br", null), " менеджер:");

var _ref25 = React.createElement("br", null);

var _ref26 = React.createElement("span", {
  class: "red"
...
var _ref29 = React.createElement("colgroup", null, React.createElement("col", {
  width: "25%"
...
var _ref30 = React.createElement("tr", null, React.createElement("td", null, "Изделия"), React.createElement("td", null, "Цвет"), React.createElement("td", null, "Кол-во, шт."), React.createElement("td", null, "Площадь, кв.м."), React.createElement("td", null, "Цена ", React.createElement("br", null), "без скидки"), React.createElement("td", null, "Скидка, %"), React.createElement("td", null, "Сумма"));

var _ref31 = React.createElement("td", {
  colspan: "2"
}, "Всего");

var _ref32 = React.createElement("colgroup", null, React.createElement("col", {
  width: "61%"
}), React.createElement("col", {
  width: "13%"
}), React.createElement("col", {
...
var _ref33 = React.createElement("th", null, "ИТОГО");

var _ref34 = React.createElement("th", null, "0");
...
var _ref38 = React.createElement("div", {
  class: "o-info"
}, React.createElement("div", {
  class: "o-info__top"
...
class Offer59 extends PrnProto {
  ...
  render() {
    ...
    return React.createElement(React.Suspense, {
      ...
      class: "o-cover"
    }, _ref13, _ref14, _ref15, React.createElement("p", {
      class: "o-cover__4 green"
    }, title), _ref16, React.createElement("div", {
      class: "o-cover__6"
    }, React.createElement("div", {
      class: "o-cover__9"
    }, _ref17, React.createElement("div", {
      class: "o-cover__8"
    }, React.createElement("div", {
      class: "o-cover__10"
    }, React.createElement("div", {
      class: "o-cover__11 green"
    }, obj.leading_manager.name), _ref18), _ref19), _ref20, _ref21, ' '), _ref22)), React.createElement("div", {
      class: "o-details"
    }, React.createElement("div", {
      class: "o-details__1"
      ...
      class: "o-details__10"
    }, _ref24, React.createElement("div", {
      class: "o-details__12 green"
    }, obj.manager.name, " ", _ref25, _ref26)))), _ref27, _ref28, React.createElement("div", {
      class: "o-details__7"
    }, React.createElement("div", {
      class: "o-details__8"
    ...
    }, React.createElement("table", null, _ref29, _ref30, products && products.map(product => React.createElement("tr", null, React.createElement("td", {
      class: "green"
      ...
      class: "green"
    }, product.price * product.quantity * (1 - product.discount)))), React.createElement("tr", null, _ref31, React.createElement("td", {
      class: "green"
    ...
    }, React.createElement("table", null, _ref32, React.createElement("tr", null, _ref33, React.createElement("th", {
      class: "green"
    }, products && products.map(product => product.price * product.quantity).reduce((acc, price) => acc += price, 0)), _ref34, React.createElement("th", {
      class: "green"
    }, products && products.map(product => product.price * product.quantity * (1 - product.discount)).reduce((acc, price) => acc += price, 0))))), _ref35, _ref36, _ref37), _ref38));
  }
